...
beforeEach(() => {
  // globalThis is available in both Node and browser contexts; `global` would
  // require pulling in @types/node, which conflicts with the web's browser-first types.
